    ...
    return (
        <>
            ...
            <section className={style.peito}>
                <Exercicio titulo="Supino Inclinado" imagem={peito1}/>
                <Exercicio titulo="Supino Reto" imagem={peito2}/>
                <Exercicio titulo="Supino Declinado" imagem={peito3}/>
            ...
            <section className={style.costa}>
                ...
                <Exercicio titulo="Remada Curvada" imagem={costa4}/>
                <Exercicio titulo="Remada na maquina" imagem={costa5}/>
                <Exercicio titulo="Remada com halter" imagem={costa6}/>
            </section>
            ...
            <Exercicio titulo="Elevação Frontal" imagem={Ombro1}/>
            <Exercicio titulo="Elevação Lateral" imagem={Ombro2}/>
            <Exercicio titulo="Desenvolvimento" imagem={Ombro3}/>
            ...
            <Exercicio titulo="Rosca Direta" imagem={Biceps1}/>
            <Exercicio titulo="Rosca Scott" imagem={Biceps2}/>
            ...
            <Exercicio titulo="Triceps Frances" imagem={triceps1}/>
            <Exercicio titulo="Triceps Corda" imagem={triceps2}/>
            ...
            <Exercicio titulo="Rotação De Punho" imagem={Ante1}/>
            <Exercicio titulo="Rosca Inversa" imagem={Ante2}/>
            </section>
            <div className={style.linha}>
                <hr></hr>
            </div>
